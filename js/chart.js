        $(function(){
            ...
            function oysterInfo() {
                ...
                div.html("<p style=\"text-align:right\"><input style = 'pointer-events: all' type='button' value='X' \
                    onclick=\"document.getElementById('oysterBox').style.opacity = 0; document.getElementById('oysterBox').style.pointerEvents = 'none'\" /></p>\
                    I created this visualization to show the importance of the role oysters play in filtering pollutants out of the Chesapeake Bay, and the \
                    detrimental effects of the massively decreased oyster population. I could not find a data analysis study on the connection between water quality and oysters \
                    so that is what I set out to achieve. Using my visualization I was able to prove that there is a connection between the oyster population at any given time and \
                    the water quality. The inverse relationship between the oyster population and levels of the pollutant nitrogen can be clearly observed in visualization (look \
                    particularly at the years 1999 and 2003 when the oyster population hit a relative peak and low respectively). With data spanning water quality stations \
                    across the entire bay there are many other interesting associations yet to be found so please explore!<p/ >The Chesapeake Bay is the largest estuary in North America. The bay was \
                    given the Algonquian name <i>Chesepiook</i> meaning 'great shell-fish bay' by Native Americans due to its abundance of oysters\
                    <a href='http://msa.maryland.gov/msa/mdmanual/01glance/html/ches.html' target = '_blank'>(1)</a>. Oyster reefs were so plentiful in the bay at one \
                    time that European explorers had a difficult time navigating around them and they rose above the surface at low tide\
                    <a href='http://www.washingtonpost.com/national/health-science/researchers-think-industrious-oysters-could-clean-up-chesapeake/2013/05/05/1778a79c-b353-11e2-9a98-4be1688d7d84_story.html' target='_blank'>(2)</a>\
                    . Oysters brought such a high profit to towns on the Chesapeake that they became known as 'Chesapeake Gold' during plentiful years such as 1898 when oystermen \
                    in Maryland alone landed 5.3 billion oysters<a href='http://www.pbs.org/newshour/rundown/restoring-the-gold-of-the-chesapeake-bay/' target='_blank'>(3)</a>.\
                    <p/>Because of the incredible filtering capability of oysters the bay was crystal clear during the time when oysters were plentiful. An acre of oysters can filter \
                    140 million gallons of water an hour and remove 3,000 pounds of nitrogen, a primary pollutant, per year\
                    <a href='http://www.pbs.org/newshour/rundown/restoring-the-gold-of-the-chesapeake-bay/' target='_blank'>(4)</a>. An adult oyster has the capability to filter \
                    about 50 gallons of water per day. Since the Chesapeake Bay contains 18 trillion gallons of water, that means it would take about 20 billion oysters to keep it \
                    completely clean. While there were easily that many oysters in the bay in the 19th century, this is no longer the case. The following time lapse video shows how \
                    effective oysters are at filtering water:<p /><center><iframe opacity=1 width=280 height=210 src='https://www.youtube.com/embed/1Zm-yMpHsaQ' frameborder=0>\
                    </iframe><br /><sup>Source: The Chesapeake Bay Foundation '<a href='https://www.youtube.com/watch?v=1Zm-yMpHsaQ' target='_blank'>Common Ground</a>' documentary\
                    </sup></center><p />The oyster population plummeted in the 1980s due to a combination of overharvesting, pollution, and disease. Sadly as the oyster population \
                    continues to decrease, pollution of the bay continues to rise. The Chesapeake Bay watershed includes 64,000 square miles across six states (Maryland, Delaware, \
                    Pennsylvania, New York, Virginia, West Virginia-and the District of Columbia) with an unusually high amount of farmland (around 25% of the total land area). As \
                    a result, agriculture is the most significant source of water pollution of the bay. Nitrogen and phosphorous are the two leading pollutants that enter the bay \
                    from runoff from farms, cities, suburbs, and air pollution, and create harmful conditions for bay grasses and aquatic life\
                    <a href='http://chesapeake.news21.com/content/sources-pollution-chesapeake-bay' target='_blank'>(5)</a>.<p />Efforts to clean the bay and restore the oyster \
                    population are critical before it reaches a point of no return. <a href='http://www.cbf.org/' target='_blank'>Save the Bay</a>"); 
            }
